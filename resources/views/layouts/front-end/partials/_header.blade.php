...
<header class="box-shadow-sm rtl" style="display: none;">
    <!-- Topbar-->
<!--    <div class="topbar">-->
<!--        <div class="container">-->
...
<!--        </div>-->
<!--    </div>-->
<!-- <hr style="border-top:4px solid #fd7e14;">-->
...
<!--                   href="{{route('home')}}">-->
<!--                    <img style="height: 30px!important;width:auto; margin-left: 45px;" class="mobile-logo-img"-->
...
<!--                                <span class="input-group-text" style="font-size: 20px;">-->
                                    <!--<i class="czi-search text-white">Search</i>-->
<!--                                   <i class="text-white"> Search</i>-->
<!--                                </span>-->
<!--                        </button>-->
...
<!--                            <i class="navbar-tool-icon czi-view-list"></i>-->
<!--                        </div>-->
<!--                    </a>-->
<!--                    <div class="navbar-tool dropdown {{Session::get('direction') === "rtl" ? 'mr-3' : 'ml-3'}}">-->
<!--                        <a class="d-none d-sm-block navbar-tool-icon-box bg-secondary dropdown-toggle" href="{{route('wishlists')}}">-->
<!--                            <span class="navbar-tool-label">-->
<!--                                <span-->
<!--                                    class="countWishlist">{{session()->has('wish_list')?count(session('wish_list')):0}}</span>-->
<!--                           </span>-->
<!--                            <i title="Wish List" class="navbar-tool-icon czi-heart-circle"></i>-->
<!--                        </a>-->
<!--                         <a class="d-sm-none navbar-tool-icon-box-mbl dropdown-toggle" href="{{route('wishlists')}}">-->
<!--                            <span class="navbar-tool-label">-->
<!--                                <span-->
<!--                                    class="countWishlist">{{session()->has('wish_list')?count(session('wish_list')):0}}</span>-->
<!--                           </span>-->
...
<!--                    @else-->
<!--                        <div class="dropdown">-->
<!--                            <a class="d-none d-sm-block navbar-tool {{Session::get('direction') === "rtl" ? 'mr-3' : 'ml-3'}}"-->
<!--                               type="button" data-toggle="dropdown" aria-haspopup="true"-->
<!--                               aria-expanded="false">-->
<!--                                <div class="navbar-tool-icon-box bg-secondary">-->
<!--                                    <div class="navbar-tool-icon-box bg-secondary">-->
<!--                                        <i class="navbar-tool-icon czi-add-user"></i>-->
<!--                                    </div>-->
<!--                                </div>-->
<!--                            </a>-->
<!--                               <a class="d-sm-none navbar-tool {{Session::get('direction') === "rtl" ? 'mr-3' : 'ml-3'}}"-->
<!--                               type="button" data-toggle="dropdown" aria-haspopup="true"-->
<!--                               aria-expanded="false">-->
<!--                                <div class="navbar-tool-icon-box-mbl">-->
<!--                                    <div class="navbar-tool-icon-box-mbl">-->
<!--                                        <i class="navbar-tool-icon czi-add-user"></i>-->
<!--                                    </div>-->
<!--                                </div>-->
...
<!--                                <i class="czi-view-list align-middle mt-n1 {{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}}"></i>-->
<!--                                <span-->
