...
<!--<footer class="font-small mdb-colorrtl">-->
    <!-- Footer Links -->
<!--    <div style="background:#3c66a7;padding-top:30px;">-->
...
<!--                            </div>-->
<!--                            <div class="row pl-2">-->
<!--                                <span style="font-size: 14px; color:white;"><i class="fa fa-map-marker m-2"></i> {{ \App\CPU\Helpers::get_business_settings('shop_address')}} </span>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
...
<!--            </div>-->
            <!-- Footer links -->
<!--        </div>-->
<!--         <img src="{{asset('public/assets/front-end/img/payment-gateway.png')}}" alt="Payment Gateway">-->
<!--    </div>-->
