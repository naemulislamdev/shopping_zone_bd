        ...
        <div class="navbar-nav-wrap">
            ...
            <div class="navbar-nav-wrap-content-left">
                ...
                <div class="d-none d-md-block">
                   <form class="form-inline" action="{{route('admin.product.productsearch')}}" method="get" enctype="multipart/form-data">
                      <div class="form-group">
                        <label class="sr-only" for="searchProduct">Search Product</label>
                        <div class="input-group">
                          <input type="text" class="form-control mr-2" name="name" id="searchProduct" placeholder="Search Product">
                        </div>
                      </div>
