    ...
    <section class="py-3">
        <div class="container">
                                ...
                                <div class="product-image2 product-image2-col-3" data-category="category">
                                    ...
                                    <a class="buy-now" href="javascript:void(0);"
                                        ...
                                        <div class="v-play-box">
                                            <a href="{{ route('product', $product->slug) }}"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="70" width="70" xmlns="http://www.w3.org/2000/svg"><path d="m10 17 6-5-6-5z"></path><path d="M12 2C6.486 2 2 6.486 2 12s4.486 10 10 10 10-4.486 10-10S17.514 2 12 2zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8z"></path></svg></a>
                                            </div>
                                </div>
            ...
            <div class="row my-3">
                ...
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="70"
