        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="left-banner">
                    ...
                    <img src="{{ asset('storage/app/public/deal') }}/{{ $landing_page->left_side_banner }}"
                        alt="">
                </div>
            </div>
        ...
        <div class="row my-3">
            <div class="col">
                <div class="middle-banner">
                    <img style="width: 100%;"
                        src="{{ asset('storage/app/public/deal') }}/{{ $landing_page->mid_banner }}" alt="">
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="left-banner">
                        {{-- <h4>Special Offer</h4>
                    <p>Get up to 50% off on selected items. Hurry, offer ends soon!</p> --}}
                        <img src="{{ asset('storage/app/public/deal') }}/{{ $landing_page->right_side_banner }}"
                            alt="">
                    </div>
                </div>
            </div>
