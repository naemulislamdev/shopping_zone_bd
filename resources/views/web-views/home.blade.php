            ...
            <div class="row">
                <div class="col-md-11 mx-auto">
                    ...
                    <div class="homeCategories owl-carousel owl-theme">
                        <div class="item">
                            <div class="tp-category-item-3 p-relative text-center z-index-1 fix mb-30">
                                <div class="tp-category-thumb-3 include-bg"
                                    style="background-image: url('{{ asset('public/assets/front-end') }}/images/category/cate-img1.jpg');">
                                </div>
                        ...
                        <div class="item">
                            <div class="tp-category-item-3 p-relative text-center z-index-1 fix mb-30">
                                <div class="tp-category-thumb-3 include-bg"
                                    style="background-image: url('{{ asset('public/assets/front-end') }}/images/category/cate-img2.jpg');">
                                </div>
                                <div class="tp-category-content-3">
                                    <h3 class="tp-category-title-3">
                        ...
                        <div class="item">
                            <div class="tp-category-item-3 p-relative text-center z-index-1 fix mb-30">
                                <div class="tp-category-thumb-3 include-bg"
                                    style="background-image: url('{{ asset('public/assets/front-end') }}/images/category/cate-img3.jpg');">
                                </div>
                                <div class="tp-category-content-3">
                                    <h3 class="tp-category-title-3">
                                        <a href="#">Clothing</a>
                        ...
                        <div class="item">
                            <div class="tp-category-item-3 p-relative text-center z-index-1 fix mb-30">
                                <div class="tp-category-thumb-3 include-bg"
                                    style="background-image: url('{{ asset('public/assets/front-end') }}/images/category/cate-img4.jpg');">
                                </div>
                                <div class="tp-category-content-3">
                                    <h3 class="tp-category-title-3">
                                    ...
                                    <form id="add-to-cart-form_{{$product->id}}" class="mb-2">
                                        ...
                                        <ul class="social">
                                            ...
                                            <li><a style="cursor: pointer"
                                                    onclick="addToCart('add-to-cart-form_{{ $product->id }}');"
                                                    data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a>
                                            </li>
                                        </ul>
                                        <button type="button" style="cursor: pointer;" class="buy-now" onclick="buy_now('add-to-cart-form_{{ $product->id }}');">Buy Now</button>
                                    </form>
                                </div>
