...
@php($decimal_point_settings = \App\CPU\Helpers::get_business_settings('decimal_point_settings'))
    ...
    @if (isset($flash_deals))
     ...
     <div class="container-fluid mt-3">
        <div class="row " style="background: white;box-shadow: 0px 3px 6px #0000000d;">
            <div class="col-md-12 title-bar pb-3" style="border-radius: 7px;">
                <div class="feature-product-title text-uppercase">
            ...
            <div class="col-md-12">
                <div class="feature-product" style="padding-left:55px;padding-right: 55px;padding-top: 10px;">
                    <div class="carousel-wrap p-1">
                        <div class="owl-carousel owl-theme " id="flash_deal_products_list">
    ...
    {{--brands--}}
    <section class="container-fluid rtl mt-3">
        <!-- Heading-->
        <div class="section-header title-bar text-uppercase" style="border-radius: 7px;">
            <div class="feature-product-title" style="margin: 0 auto;
padding-top: 6px; color: white; font-weight: 900;
            font-size: 30px;">
                <span> {{\App\CPU\translate('brands')}}</span>
                
            </div>
                    <div style="margin-right: 4px; margin-top: 15px;">
                            <a class="text-capitalize view-all-text" style="color:white!important;"
                               href="{{route('brands')}}">
    ...
    <!-- Grid-->
        ...
        <div class="mt-3 mb-3 brand-slider" style="background-color:white">
    ...
    <div class="container-fluid mb-4">
        <div class="row" style="background: white;box-shadow: 0px 3px 6px #0000000d;border-radius: 5px;">
            <div class="col-md-12 title-bar" style="border-radius: 7px;">
                <div class="feature-product-title text-uppercase pb-3">
    ...
    @if(isset($featured_deals))
        <section class="container-fluid featured_deal rtl mb-2">
            <div class="row" style="background: {{$web_config['primary_color']}};padding:5px;padding-bottom: 25px; border-radius:5px;">
                ...
                <div class="col-xl-3 col-md-4 d-flex align-items-center justify-content-center right">
                    <div class="m-4" style="border-radius: 7px;">
        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-md-8 mt-2 pl-0 pr-0">
                <div class="latest-product-margin" style="margin-{{Session::get('direction') === "rtl" ? 'right:30px' : 'left:30px'}}" >
                    <div class="d-flex justify-content-between title-bar" style="border-radius: 7px;">
                        <div class="" style="text-align: center;">
                            <span class="for-feature-title text-uppercase" style="text-align: center;font-size:22px !important; font-weight:700">{{ \App\CPU\translate('latest_products')}}</span>
                        </div>
...
@php($main_section_banner = \App\Model\Banner::where('banner_type','Main Section Banner')->where('published',1)->orderBy('id','desc')->latest()->first())
            ...
            @if(count($top_sellers) > 0)
                <div class="col-md-12 mt-2 mt-md-0 seller-card" >
                    <div class="card" style="min-height: 383px;">
                        <div class="card-body">
                            <div class="row d-flex justify-content-between title-bar text-uppercase" >
                                <div class="seller-list-title" style="border-radius: 7px;">
    ...
    <div class="container-fluid rtl mt-3 title-bar">
        <div class="row d-flex justify-content-center">
            ...
            <div style="margin-top:24px;font-weight: 700;font-size: 26px;">
                <p style="float: right; color:white">{{ \App\CPU\translate('ARRIVALS')}}</p>
            </div>
        </div>
    </div>
    <div class="container-fluid rtl mb-3" style="">
    ...
    <div class="container-fluid rtl">
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <div class="row d-flex justify-content-between m-3 title-bar" style="border-radius: 7px;">
                            <div>
                                <img style="height:30px;width:30px;"  src="{{asset("public/assets/front-end/png/best sellings.png")}}"
                                         alt="">
                                    <span style="margin-left:10px;text-transform: uppercase;font-weight: 700; color:white">{{ \App\CPU\translate('best sellings')}}</span>
                            </div>
                            <div>
                                <a class="text-capitalize view-all-text" style="color:white!important"
                        ...
                        <div class="row d-flex justify-content-between m-3 title-bar" style="border-radius: 7px;">
                            <div>
                                <img style="height:30px;width:30px;"  src="{{asset("public/assets/front-end/png/top-rated.png")}}"
                                         alt="">
                                    <span style="margin-left:10px;text-transform: uppercase;font-weight: 700; color:white">{{ \App\CPU\translate('top rated')}}</span>
                            </div>
                            <div>
                                <a class="text-capitalize view-all-text" style="color:white!important"
    ...
    {{-- Banner  --}}
    <div class="container-fluid rtl mt-3 mb-3">
        <div class="row">
    ...
    @foreach($home_categories as $category)
        <section class="container-fluid rtl mb-3">
            <!-- Heading-->
            <div style="background: #ffffff; padding:20px;border-radius:5px;">
                <div class="flex-between title-bar pl-4" style="border-radius:5px;">
...
<script>
    $('#featured_products_list').owlCarousel({
        loop: true,
         ...
         $('#flash_deal_products_list').owlCarousel({
        loop: true,
            autoplay: true,
            margin: 5,
            nav: true,
