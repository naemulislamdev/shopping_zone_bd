                ...
                <div class="col-md-3">
                    <div class="p-details-contact-section">
                        ...
                        <div class="pay-method">
                            <span>Payment</span>
                            <img src="{{ asset('public/assets/front-end/images/payment/payment.png') }}" alt="">
                        </div>
                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <div class="d-flex justify-content-between mt-2" id="chosen_price_div">
                                        <div class="product-description-label" style="font-size: 17PX; line-height: 2rem">
                                            {{ __('Total Price') }}:
                                            <strong
                                ...
                                <div class="accordion mb-3" id="accordionExample">
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between align-items-center"
                                            ...
                                            <span class="toggle-icon" data-toggle="collapse" data-target="#sizeChart"
                                                aria-expanded="true" aria-controls="sizeChart"><i
                                                    class="fa fa-plus"></i></span>
                                        </div>

                                        <div id="sizeChart" class="collapse show" aria-labelledby="productSizeChart"
                                ...
                                <div class="accordion mb-3" id="accordionExample">
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between align-items-center"
                                            ...
                                            <span class="toggle-icon" data-toggle="collapse" data-target="#description"
                                                aria-expanded="true" aria-controls="description"><i
                                                    class="fa fa-plus"></i></span>
                                        </div>

                                        <div id="description" class="collapse show" aria-labelledby="productDescription"
                                            data-parent="#accordionExample">
                                            <div class="card-body">
                                                <p>
                                                    {!! $product['details'] !!}
