...
class LandingPagesController extends Controller
{
    ...
    public function landing_submit(Request $request)
    {
        ...
        $flash_deal_id = DB::table('landing_pages')->insertGetId([
            ...
            // 'side_banner' => $request->has('image') ? ImageManager::upload('deal/', 'png', $request->file('image')) : 'def.png',
     ...
     public function update(Request $request, $deal_id)
    {
        ...
        if ($request->image1) {
            $deal->main_banner = ImageManager::update('deal/', $deal->mid_banner, 'png', $request->file('image1'));
        }
