...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.','middleware'=>['module:user_section']], function () {
            ...
            Route::get('intialCustomerList', 'CustomerController@intialCustomerList')->name('intialCustomerList');
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.','middleware'=>['module:product_management']], function () {
            ...
            Route::get('CampaingDelete/{id}','ProductController@CampaingDelete')->name('CampaingDelete');
...
//                Route::get('app', 'LanguageController@index_app')->name('index-app');
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order_management']], function () {
            ...
            Route::get('Individual/{status}','OrderController@Individual')->name('Individual');
            Route::post('ordersPrice/{id}', 'OrderController@ordersPrice')->name('ordersPrice');
            Route::get('detailsProduct/{product_id}', 'OrderController@detailsProduct')->name('detailsProduct');
