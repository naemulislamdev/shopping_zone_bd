...
Route::group(['namespace' => 'api\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'auth'], function () {
         ...
         Route::post('sendOtp', 'PassportAuthController@sendOtp')->name('sendOtp');
         Route::get('recivedotp', 'PassportAuthController@recivedOTP')->name('recivedotp');
    ...
    Route::group(['prefix' => 'shipping-method','middleware'=>'auth:api'], function () {
     ...
     Route::group(['prefix' => 'cart','middleware' => 'auth:api'], function () {
        ...
        Route::post('cartAdd', 'CartController@cart_to_db_api');
    ...
    Route::get('company-info','GeneralController@conpanyInfo');
    Route::get('company-phone','GeneralController@conpanyInfo1');
    Route::get('company-name','GeneralController@conpanyInfo2');
    Route::get('company-email','GeneralController@conpanyInfo3');
    Route::get('company-footer-logo','GeneralController@conpanyInfo4');
    Route::get('company-copyright-text','GeneralController@conpanyInfo5');
    Route::get('company-about','GeneralController@conpanyInfo6');
    Route::get('company-address','GeneralController@conpanyInfo7');
    Route::get('SocialMedia','GeneralController@SocialMedia1');
    Route::get('facebookPost','GeneralController@facebookPost');
    Route::get('metaTitle','GeneralController@metaTitle');
    Route::get('terms-condition', 'GeneralController@terms_condition');
    Route::get('privacy-policy', 'GeneralController@privacy_policy');

    Route::group(['prefix' => 'products'], function () {
        Route::get('latest', 'ProductController@get_latest_products');
        Route::get('latestWeb', 'ProductController@get_latestWeb_products');
        Route::get('featured', 'ProductController@get_featured_products');
        Route::get('featuredWeb', 'ProductController@get_featuredWeb_products');
        Route::get('top-rated', 'ProductController@get_top_rated_products');
        Route::get('search/{key}', 'ProductController@get_searched_products');
        Route::any('Appsearch', 'ProductController@get_Appsearch_products');
        Route::post('searchPrice', 'ProductController@price_reanges');
        Route::get('colorSearch/{key}', 'ProductController@colorSearch');
        Route::get('Color', 'ProductController@Color');
        Route::get('details/{slug}', 'ProductController@get_product');
        Route::get('discount/details/{slug}/{id}', 'ProductController@get_product_discount');
        ...
        Route::get('shipping-methods', 'ProductController@get_shipping_methods');
         Route::get('shipping-methods/{id}', 'ProductController@get_shipping_methods_id');
        ...
        // ProductCampaing
        Route::delete('CampaingDelete','ProductController@CampaingDelete');
    });
    ...
    Route::group(['prefix' => 'flash-deals'], function () {
        ...
        Route::get('flash-deal-products', 'FlashDealController@get_products_for_flash_deal');
        Route::get('campaing-products', 'FlashDealController@campaing_products');
        Route::get('campaing-products-tomrrrow', 'FlashDealController@campaing_products_tomrrrow');
        Route::get('countdown', 'FlashDealController@get_flash_deal_for_countdown');
    });
    ...
    Route::group(['prefix' => 'categories'], function () {
        ...
        Route::get('/{category_id}', 'CategoryController@get_subcategories');
        Route::get('products/{category_id}', 'CategoryController@get_products');
        Route::get('products_slug/{category_slug}', 'CategoryController@get_products_slug');
    });
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::group(['prefix' => 'chat'], function () {
            ...
            Route::get('send-message', 'ChatController@messages_store');
        });
